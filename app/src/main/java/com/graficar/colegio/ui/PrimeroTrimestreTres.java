...
public class PrimeroTrimestreTres extends AppCompatActivity {
    ...
    private final String trimestreActual = "trimestre3"; // CAMBIADO A TRIMESTRE 3
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_primero_trimestre_tres);
        inicializarColumnas();
        inicializarViews();
        configurarListeners();
        cargarDatos();
    ...
    private void cargarEstudiantes() {
        dbRef.child("estudiantes").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                int contador = 1;
                if (!snapshot.exists()) {
                    Toast.makeText(PrimeroTrimestreTres.this, "No hay estudiantes", Toast.LENGTH_SHORT).show();
                    mostrarMensajeVacio();
                    return;
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(PrimeroTrimestreTres.this, "Error: " + error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }

    // ============================================================
    // CARGAR CALIFICACIONES - TRIMESTRE 3
    // ============================================================
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot uidSnapshot : snapshot.getChildren()) {
                        ...
                        DataSnapshot materiaSnapshot = uidSnapshot
                                .child(trimestreActual) // trimestre3
                                .child(materiaActual);
    ...
    private void crearEncabezados() {
        ...
        TextView tvObs = crearTextViewEncabezado("OBSERVACIONES (T3)", ANCHO_OBSERVACIONES);
                        ...
                        if (claveFinal.equals("autoevaluacion") && !nuevoValor.equals("--")) {
                            try {
                                ...
                                if (valorAuto > 5) {
                                    ...
                                    modificando = false;
                                    Toast.makeText(PrimeroTrimestreTres.this,
    ...
    private void actualizarTituloInicial() {
        ...
        tvTituloCurso.setText("PRIMERO C - MATEMÁTICA (TRIMESTRE 3) - "
