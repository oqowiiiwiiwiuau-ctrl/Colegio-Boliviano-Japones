...
public class PrimeroTrimestreUno extends AppCompatActivity {
    ...
    // Total antes de autoevaluación:
    // SER 5 + SABER 45 + HACER 40 = 90
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(
                R.layout.activity_primero_trimestre_uno
        );
    ...
    // ============================================================
    // OBTENER MÁXIMO DEL PADRE
    // ============================================================

    private double obtenerMaximoPadre(
            String padreId
    ) {
    ...
    // ============================================================
    // OBTENER MÁXIMO DE HIJA
    // ============================================================

    private double obtenerMaximoHija(
            String padreId
    ) {
        ...
        switch (padreId) {
            ...
            case "saber":
                return MAX_SABER_HIJA;

            case "hacer":
                return MAX_HACER_HIJA;
    ...
    private double calcularPromedioPadre(
        ...
        // --------------------------------------------------------
        // Si no existen hijas, se utiliza la nota directa del padre
        // --------------------------------------------------------
    ...
    private void recalcularNotaPadre(
        ...
        // --------------------------------------------------------
        // CONVERSIÓN A LA ESCALA DEL PADRE
        // --------------------------------------------------------
        //
        // SER:
        // promedio / 10 * 5
        ...
        if (notaPadre > maximoPadre) {
            notaPadre = maximoPadre;
        }
    ...
    private void actualizarTituloInicial() {
        ...
        tvTituloCurso.setText(
                "PRIMERO C - MATEMÁTICA (TRIMESTRE 1) - "
    ...
    private void calcularNotas(
        ...
        // NOTA TRIMESTRAL
        //
        // NOTA PARCIAL = máximo 95
        // PONDERACIÓN  = máximo 10
        //
        // 95 + 10 = 105
        //
        // Pero la nota final jamás puede superar 100.
        // ========================================================
