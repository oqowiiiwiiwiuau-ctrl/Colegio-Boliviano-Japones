...
public class PrimeroTrimestreDos extends AppCompatActivity {
    ...
    private final String trimestreActual = "trimestre2"; // CAMBIADO A TRIMESTRE 2
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_primero_trimestre_dos);
        inicializarColumnas();
        inicializarViews();
        configurarListeners();
        cargarDatos();
    ...
    private void cargarEstudiantes() {
        dbRef.child("estudiantes").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                int contador = 1;
                if (!snapshot.exists()) {
                    Toast.makeText(PrimeroTrimestreDos.this, "No hay estudiantes", Toast.LENGTH_SHORT).show();
                    mostrarMensajeVacio();
                    return;
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(PrimeroTrimestreDos.this, "Error: " + error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }

    // ============================================================
    // CARGAR CALIFICACIONES - TRIMESTRE 2
    // ============================================================
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot uidSnapshot : snapshot.getChildren()) {
                        ...
                        DataSnapshot materiaSnapshot = uidSnapshot
                                .child(trimestreActual) // trimestre2
                                .child(materiaActual);
    ...
    private void crearEncabezados() {
        ...
        TextView tvObs = crearTextViewEncabezado("OBSERVACIONES (T2)", ANCHO_OBSERVACIONES);
                        ...
                        if (claveFinal.equals("autoevaluacion") && !nuevoValor.equals("--")) {
                            try {
                                ...
                                if (valorAuto > 5) {
                                    ...
                                    modificando = false;
                                    Toast.makeText(PrimeroTrimestreDos.this,
    ...
    private void actualizarTituloInicial() {
        ...
        tvTituloCurso.setText("PRIMERO C - MATEMÁTICA (TRIMESTRE 2) - "
